...
- [深度学习性质预测](23_deep_learning_property_prediction.md)（54 个可直接推理功能，含 27 个本地完整微调 checkpoint 分类任务）
- [深度学习任务 Checkpoint 下载](25_deep_learning_checkpoint_download.md)（27 个任务权重的下载与本地放置）
