...
LAUNCHER_MODEL_NAME="alphagenome"
LAUNCHER_CONDA_ENV="alphagenome"
LAUNCHER_DEFAULT_FINETUNE_METHOD="frozen_linear_probe"
LAUNCHER_DEFAULT_DEVICE="cuda"
LAUNCHER_DEFAULT_LOG_ROOT="/zengxiangxiang/mps/visualdna/outputs/visualdna_benchmark/nt_grid_alphagenome"
